...
class SystemMetrics:
    ...
    def is_performance_acceptable(self, 
                                max_error_rate: float = 0.1,
                                max_response_time_ms: int = 1000) -> bool:
        """パフォーマンス許容判定"""
...
class SystemStatus:
    ...
    def create_with_components(cls,
                             ...
                             metrics: Optional[SystemMetrics] = None) -> 'SystemStatus':
        """コンポーネント付きシステム状態作成"""
        components_dict = {
            comp.component_name: comp for comp in component_healths
        }
    ...
    @staticmethod
    def _calculate_overall_health(component_healths: List[ComponentHealth]) -> HealthStatus:
        """全体ヘルス計算"""
    ...
    def update_component_health(self, component_name: str, new_health: ComponentHealth) -> 'SystemStatus':
        """コンポーネントヘルス更新"""
    ...
    def get_unhealthy_components(self) -> List[ComponentHealth]:
        """不健全コンポーネント取得"""
        return [
            comp for comp in self.component_healths.values()
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "component_healths": {
                name: comp.to_dict()
                for name, comp in self.component_healths.items()
            },
    ...
    def __str__(self) -> str:
        ...
        return (f"SystemStatus[{self.overall_health.name}] "
