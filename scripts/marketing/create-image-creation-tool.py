...
英語で応答し、プロンプトのみを出力してください。""",
    ...
    workflow_data = {
        ...
        "connections": {
            ...
            "Image Prompt Agent": {
                "main": [[{"node": "OpenAI Image Generation", "type": "main", "index": 0}]]
            },
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print(f"📝 名前: {name}")
        print(f"\n機能:")
        print(f"✅ OpenAI DALL-E 3画像生成")
        print(f"✅ プロンプト最適化エージェント")
        print(f"✅ ファイル変換")
        print(f"✅ データベースログ記録")
        print(f"⚠️ Telegramはモック実装")
        print(f"⚠️ Google Driveはスキップ")
    else:
        print(f"\n❌ **画像作成ツール作成失敗**")