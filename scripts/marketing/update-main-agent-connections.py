...
def update_main_agent_connections():
    ...
    response = requests.get(
        f"{base_url}/api/v1/workflows/{main_agent_id}", headers=headers
    )
...
if __name__ == "__main__":
    ...
    if connection_success and table_success:
        print("\n🎊 **統合設定成功** 🎊")
        print("✅ メインエージェント ⟷ 画像作成ツール接続完了")
        print("✅ データベース設計完了")
        print("\n📡 テスト用URL:")
        print("https://dd1107.app.n8n.cloud/webhook/marketing-agent-1752541701")
    else:
        print("\n⚠️ **統合設定要確認**")
