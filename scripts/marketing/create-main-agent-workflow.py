  ...
  "response": "ユーザーへの応答メッセージ"
                ...
                "values": [
                    {
                        "conditions": {
                            "string": [
                                {"value1": "={{$json.tool}}", "value2": "create_image"}
                            ]
                        },
                        "renameOutput": True,
                    ...
                    },
                    {
                        "conditions": {
                            "string": [
                                {"value1": "={{$json.tool}}", "value2": "edit_image"}
                            ]
                        },
                        "renameOutput": True,
                    ...
                    },
                    {
                        "conditions": {
                            "string": [
                                {"value1": "={{$json.tool}}", "value2": "blog_post"}
                            ]
                        },
                        "renameOutput": True,
                        "outputKey": "blog_post",
                    },
                    {
                        "conditions": {
                            "string": [
                                {"value1": "={{$json.tool}}", "value2": "linkedin_post"}
                            ]
                        },
                        "renameOutput": True,
                    ...
                    {
                        "conditions": {
                            "string": [{"value1": "={{$json.tool}}", "value2": "video"}]
                        },
                        "renameOutput": True,
                        "outputKey": "video",
                    },
    ...
    workflow_data = {
        ...
        "connections": {
            ...
            "Tool Switch": {
                "create_image": [
                    [{"node": "Create Image Tool", "type": "main", "index": 0}]
                ],
                "NoMatch": [
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print(f"📝 名前: {name}")
        print("\n次のステップ:")
        print("1. サブワークフロー（画像作成等）の作成")
        print("2. 必要なAPIキーの追加設定")
        print("3. 統合テスト実行")
    else:
        print("\n❌ **メインエージェント作成失敗**")
