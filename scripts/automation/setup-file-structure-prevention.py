...
def main():
    ...
    try:
        ...
        print("\n📋 次のステップ:")
        print(
            "   1. 緊急修正実行: python3 scripts/automation/emergency-file-structure-fix.py"
        )
        print("   2. 監視開始: python3 scripts/automation/file-structure-watcher.py")
        print("   3. Git設定確認: git config core.hooksPath .git/hooks")
