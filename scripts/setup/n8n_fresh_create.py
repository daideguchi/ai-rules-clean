...
def delete_all_claude_workflows():
    ...
    for workflow in workflows:
        ...
        if any(
            keyword in name.lower() for keyword in ["claude", "performance", "rebuilt"]
        ):
...
def create_fresh_workflow():
                ...
                "parameters": {
                    ...
                    "bodyParameters": {
                        "parameters": [
                            ...
                            {
                                "name": "session_notes",
                                "value": "Fresh workflow - autonomous AI growth",
                            },
                        ]
                    },
                },
    ...
    try:
        ...
        response = requests.post(
            f"{base_url}/api/v1/workflows", headers=headers, json=workflow_definition
        )
...
def main():
    ...
    if test_success:
        ...
        print("\n🚨 **統合テスト失敗**")
        print("   Webhook URLまたはSupabase連携に問題")
