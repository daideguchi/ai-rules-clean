...
def force_activate_workflow():
    ...
    # 方法1: POST /activate
    print(f"   方法1: POST /activate エンドポイント")
    ...
    print(f"   方法2: PUT with active=True")
    ...
    print(f"   方法3: PATCH with active=True")
    ...
    if check_response.status_code == 200:
        ...
        if new_active_status:
            ...
            if test_response.status_code == 200:
                print(f"   ✅ Webhook正常動作確認")
                return True
            else:
                print(f"   ❌ Webhookまだ動作せず")
                return False
        else:
            print(f"   ❌ アクティブ化失敗")
            return False
