        ...
        try:
            ...
            for workflow in workflows:
                ...
                if any(
                    ...
                    for keyword in ["claude", "performance", "simple"]
                ):
                    ...
                    if delete_response.status_code == 200:
                        ...
                        print(
                            f"   ❌ 削除失敗: {name} - Status: {delete_response.status_code}"
                        )
    ...
    def create_simple_working_workflow(self):
        ...
        supabase_node = {
            "parameters": {
                ...
                "headerParameters": {
                    "parameters": [
                        {"name": "apikey", "value": self.supabase_anon_key},
                        {
                            "name": "Authorization",
                ...
                if not workflow_data.get("active"):
                    ...
                    if activate_response.status_code == 200:
                        ...
                        if activate_response2.status_code == 200:
                            ...
                            print(
                                f"   ⚠️ 代替アクティブ化も失敗: {activate_response2.status_code}"
                            )
...
def main():
    ...
    if final_success:
        print("\n🎉 **完全再構築成功**")
        print("   n8n→Supabase統合が正常に動作しています")
        print(f"   Webhook URL: {webhook_url}")
    else:
        print("\n🚨 **再構築失敗**")
        print("   追加の修正が必要です")
