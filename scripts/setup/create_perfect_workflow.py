...
def create_perfect_workflow():
        ...
        "parameters": {
            ...
            "bodyParameters": {
                "parameters": [
                    ...
                    {"name": "tool_calls_count", "value": "={{$json.tool_calls.length}}"},
    ...
    if response.status_code in [200, 201]:
        ...
        print(f"🔧 手動アクティブ化が必要: n8n UIでワークフローを手動でアクティブ化してください")
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print(f"📝 名前: {name}")
        print(f"\n⚠️ 次のステップ:")
        print(f"1. n8n UIでワークフローを手動アクティブ化")
        print(f"2. アクティブ化後にテスト実行")
